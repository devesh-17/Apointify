...
import { NavigationItem, NavigationItems } from '../../../modules/dashboard/admin-layout/navigation/nav-content/navigation';
  ...
  setBreadcrumb() {
    this.route.events.subscribe((router: Event) => {
      if (router instanceof NavigationEnd) {
        ...
        this.titleService.setTitle(title + ' | CityConnect');
      }
    });
  }
